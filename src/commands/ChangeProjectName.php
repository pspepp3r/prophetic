...
class ChangeProjectName extends Command
{
  ...
  public function execute(InputInterface $input, OutputInterface $output): int
  {
    ...
    } else if (!file_exists($consoleFilePath)) {
    ...
    copy($consoleFile, "$consoleFilePath$projectName");
    unlink($consoleFile);

    $output->write("Project name changed to $projectName, please call all commands as `php $projectName <command>` now!", true);
